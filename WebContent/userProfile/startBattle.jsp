  ...
  <body>
   ...
   %>   
    ...
    <div class="container-fluid">
        <div class="span9">
          <div class="hero-unit">
           <form class="form-horizontal"  action="startBattle.action" method="post">  
           ...
           <div class="control-group">
           <label class="control-label" for="battleType">房间类型</label>
           <div class="controls">
           <input type="text" name="battleType" placeholder="1" >
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="gameType">游戏类型</label>
           <div class="controls">
           <input type="text" name="gameType" placeholder="0" >
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="battlePrize">金币</label>
           <div class="controls">
           <input type="text" name="battlePrize" placeholder="" >
           </div>
           </div>
            <div class="controls">

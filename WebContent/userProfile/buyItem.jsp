  ...
  <body>
   ...
   %>   
    ...
    <div class="container-fluid">
        <div class="span9">
          <div class="hero-unit">
           <form class="form-horizontal"  action="itemPurchase.action" method="post">  
           ...
           <div class="controls">
           <input type="text" name="itemId" placeholder="1" value="<%=request.getAttribute("id")%>" readonly="readonly">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="itemName">道具名称</label>
           <div class="controls">
           <input type="text" name="itemName" placeholder="itemtest" value="<%=request.getAttribute("name")%>" readonly="readonly">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="gameType">游戏类型</label>
           <div class="controls">
           <input type="text" name="gameType" placeholder="1" value="<%=request.getAttribute("gameType")%>" readonly="readonly">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="gamePrice">游戏价格</label>
           <div class="controls">
           <input type="text" name="gamePrice" placeholder="1" value="<%=request.getAttribute("itemprice")%>" readonly="readonly">
           </div>
           </div>
           <div class="control-group">

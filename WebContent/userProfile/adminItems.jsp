 ...
 <head>
  ...
  <body>
   ...
   %>   
    ...
    <s:iterator id="itemInfo" value="#request.itemInfos"> 
    <tr>  
        <td>${itemInfo.id}</td>
         <td>${itemInfo.gameType}</td>  
         <td>${itemInfo.itemName}  </td>
         <td>${itemInfo.itemPrice}</td>  
         <td>${itemInfo.comment}</td>
         <td>
         <a href="deleteItem.action?id=${itemInfo.id}"> 删除</a>
         <a href="configPage/updateItem.jsp?id=${itemInfo.id}&gameType=${itemInfo.gameType}&itemName=${itemInfo.itemName}&itemPrice=${itemInfo.itemPrice}&comment=${itemInfo.comment}">更新</a>
         </td>
     </tr>  
     </s:iterator> 
      </table>  

 ...
 <head>
  ...
  <body>
   ...
   %>   
    ...
    <s:iterator id="userItem" value="#request.useItems"> 
    <tr>  
         <td>${userItem.id}</td>
         <td>${userItem.itemId}</td>  
         <td>${userItem.itemName}</td>
         <td>${userItem.itemNum}</td>
         <td>${userItem.gameType}</td>
         <td>${userItem.comment}</td>   
         <td>
            <a href="purchaseItem.action?itemId=${userItem.itemId}&itemName=${userItem.itemName}&gameType=${userItem.gameType}"> 消费</a>
            <a href="giftItem.action?itemId=${userItem.itemId}&itemName=${userItem.itemName}&gameType=${userItem.gameType}"> 赠送</a>
         </td>
    </tr>  
 </s:iterator> 
</table>  

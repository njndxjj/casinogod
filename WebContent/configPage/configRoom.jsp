   ...
   %>   
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
              <form class="form-horizontal"  action="addRoom.action" method="post">  
           ...
           <div class="control-group">
           <label class="control-label" for="roomLevel">房间类型</label>
           <div class="controls">
           <input type="text" name="roomLevel" placeholder="1">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="levelScore">房间分数</label>
           <div class="controls">
           <input type="text" name="levelScore" placeholder="1000">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="minHand">最低分数</label>
           <div class="controls">
           <input type="text" name="minHand" placeholder="1000">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="maxHand">最高分数</label>
           <div class="controls">
           <input type="text" name="maxHand" placeholder="1">
           </div>
           </div>
        ...
        onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'2008-03-08 11:30:00',maxDate:'9999-12-31 24:59:59'});">
           ...
           <div class="controls">
           <input type="text" name="otherNotes" placeholder="说明">
           </div>
           </div>
            <div class="controls">

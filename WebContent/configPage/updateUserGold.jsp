  ...
  <body>
   ...
   %>   
    ...
    <div class="container-fluid">
        <div class="span9">
          <div class="hero-unit">
           <form class="form-horizontal"  action="updateGold.action" method="post">  
           ...
           <div class="control-group">
           <label class="control-label" for="gold">金币</label>
           <div class="controls">
           <input type="text" name="gold"  value=<%=request.getParameter("gold") %>>
           </div>
           </div>
            <div class="control-group">
           <label class="control-label" for="diamond">钻石</label>
           <div class="controls">
           <input type="text" name="diamond"  value=<%=request.getParameter("diamond") %>>
           </div>
           </div>
            <div class="controls">

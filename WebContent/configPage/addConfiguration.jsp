   ...
   %>   
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
              <form class="form-horizontal"  action="addconfiguration.action" method="post">  
           <div class="control-group">
           <label class="control-label" for="winTimes">次数</label>
           <div class="controls">
           <input type="text" id="winTimes" placeholder="0" name="winTimes">
           </div>
           </div>
            <div class="control-group">
           <label class="control-label" for="rankSize">名次</label>
           <div class="controls">
           <input type="text" id="rankSize" placeholder="0" name="rankSize">
           </div>
           </div>
            <div class="control-group">
           <label class="control-label" for="bossRewardNum">数量</label>
           <div class="controls">
           <input type="text" id="bossRewardNum" placeholder="0" name="bossRewardNum">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="invitedReward">奖励金额</label>
           <div class="controls">
           <input type="text" id="invitedReward" placeholder="0" name="invitedReward">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="invitedItem">奖励道具</label>
           <div class="controls">
           <input type="text" id="invitedItem" placeholder="0" name="invitedItem">
           </div>
           </div>

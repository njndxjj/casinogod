   ...
   %>   
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
              <form class="form-horizontal"  action="addTask.action" method="post">  
           <div class="control-group">
           <label class="control-label" for="taskType">类型</label>
           <div class="controls">
           <input type="text" id="taskType" placeholder="0" name="taskType">
           </div>
           </div>
            <div class="control-group">
           <label class="control-label" for="taskRate">次数</label>
           <div class="controls">
           <input type="text" id="taskRate" placeholder="0" name="taskRate">
           </div>
           </div>
            <div class="control-group">
           <label class="control-label" for="battleType">比赛类型</label>
           <div class="controls">
           <input type="text" id="battleType" placeholder="0" name="battleType">
           </div>
           </div>
            <div class="control-group">
           <label class="control-label" for="gameType">游戏类型</label>
           <div class="controls">
           <input type="text" id="gameType" placeholder="0" name="gameType">
           </div>
           </div>
            <div class="control-group">
           <label class="control-label" for="itemId">item类别</label>
           <div class="controls">
           <input type="text" id="itemId" placeholder="0" name="itemId">
           </div>
           </div>
            <div class="control-group">
           <label class="control-label" for="itemNum">个数</label>
           <div class="controls">
           <input type="text" id="itemNum" placeholder="0" name="itemNum">
           </div>
           </div>
           ...
           <div class="controls">
           <input type="text" id="isDaily" placeholder="0" name="isDaily">
           </div>
           </div>
           ...
           <div class="controls">
           <input type="text" id="description" placeholder="0" name="description">
           </div>
           </div>

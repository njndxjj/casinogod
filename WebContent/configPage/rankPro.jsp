 ...
 <head>
  ...
  <body>
   ...
   %>   
    ...
    <s:iterator id="rankType" value="#request.RankTypeInfos"> 
    <tr>  
        <td>${rankType.typeId}</td>
         <td>${rankType.rankName}</td>  
         <td>${rankType.startTime}  </td>
         <td>${rankType.endTime}</td>  
         <td>${rankType.rankDescription}</td>
         <td>
         <a href="deleteRank.action?typeId=${rankType.typeId}"> 删除</a>
         <a href="queryRankById.action?typeId=${rankType.typeId}">更新</a>
         </td>
     </tr>  
     </s:iterator> 
      </table>  

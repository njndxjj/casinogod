...
<title>boardCastProfile</title>
<script type="text/javascript" type="text/javascript" src="../My97DatePicker/WdatePicker.js">
...
//	alert(document.getElementById("firstPage").href+"&pageSize="+field.value);
  ...
  <body>
   ...
   %>   
    ...
    <s:iterator id="boardCast" value="#request.boardCastInfo"> 
    <tr>  
         <td>${boardCast.id}</td>
         <td>${boardCast.title}</td>  
         <td>${boardCast.content}</td>
         <td>${boardCast.startDate}</td>  
         <td>${boardCast.endDate}</td>
    </tr>  
 </s:iterator> 
</table>  
      </div>

      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
           ...
           <div class="controls">
           <input type="text" id="productId" placeholder="cn.mobage.g13000110" name="productId">
           </div>
           </div>
           <div class="control-group">
           ...
           <label class="control-label" for="diamond">道具价格</label>
           <div class="controls">
           <input type="text" id="diamond" name="diamond" placeholder="5" >
           </div>
           </div>
            <div class="control-group info">
           <label class="control-label" for="unit">数量</label>
           <div class="controls">
           <input type="text" id="unit" name="unit" placeholder="10" >
           </div>
           </div>
            <div class="controls">

   ...
   %>   
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
           <form class="form-horizontal"  action="addChatRoom.action" method="post">  
           <div class="control-group">
           <label class="control-label" for="account">用户ID</label>
           <div class="controls">
           <input type="text" id="account" placeholder="0" name="account">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="content">内容</label>
           <div class="controls">
           <input type="text" id="content" placeholder="0" name="content">
           </div>
           </div>

 ...
 <head>
  ...
  <body>
   ...
   %>   
    ...
    <s:iterator id="chatLimit" value="#request.chatLimitList"> 
    <tr>  
        <td>${chatLimit.userId}</td>  
         <td>${chatLimit.startTime}  </td>
         <td>${chatLimit.endTime}</td>  
         <td>
         <a href="deleteChatLimit.action?account=${chatLimit.userId}"> 删除</a>
         <a href="queryChatLimitById.action?account=${chatLimit.userId}">更新</a>
         </td>
     </tr>  
     </s:iterator> 
      </table>  

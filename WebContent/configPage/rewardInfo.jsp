  ...
  <body>
   ...
   %>   
    ...
    <tr>  
        <th width="39%">编号</th>  
        <th width="39%">账号</th> 
        <th width="39%">最后登入时间</th>
        <th width="39%">连续登入天数</th>
    </tr> 
    <s:iterator id="logInReward" value="#request.logInRewards"> 
    <tr>  
         <td>${logInReward.id}</td>
         <td>${logInReward.userId}</td>  
         <td>${logInReward.logInTime}</td>
         <td>${logInReward.lastTimes}</td>
    </tr>  
 </s:iterator> 
</table>  
      </div>

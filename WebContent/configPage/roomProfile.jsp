...
//	alert(document.getElementById("firstPage").href+"&pageSize="+field.value);
  ...
  <body>
   ...
   %>   
    ...
    <s:iterator id="roomInfo" value="#request.roomInfos"> 
    <tr>  
         <td>${roomInfo.id}</td>
         <td>${roomInfo.gameType}</td>  
         <td>${roomInfo.roomLevel}</td>
         <td>${roomInfo.levelScore}</td>
         <td>${roomInfo.minHand}</td>
         <td>${roomInfo.maxHand}</td>
         <td>${roomInfo.beginTime}</td>
         <td>${roomInfo.endTime}</td>
         <td>${roomInfo.otherNotes}</td>  
         <td>
         <a href="deleteRoom.action?id=${roomInfo.id}"> 删除</a>
         <a href="configPage/updateRoom.jsp?id=${roomInfo.id}&gameType=${roomInfo.gameType}&roomLevel=${roomInfo.roomLevel}
         &levelScore=${roomInfo.levelScore}&minHand=${roomInfo.minHand}&maxHand=${roomInfo.maxHand}&beginTime=${roomInfo.beginTime}
         &endTime=${roomInfo.endTime}&otherNotes=${roomInfo.otherNotes}">更新</a>
         </td> 
    </tr>  
 </s:iterator> 
</table>  

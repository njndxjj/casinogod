   ...
   %>   
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
           <form class="form-horizontal"  action="configItem.action" method="post">  
           <div class="control-group">
           <label class="control-label" for="gameType">游戏类型</label>
           <div class="controls">
           <input type="text" id="gameType" placeholder="游戏类型" name="gameType">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="itemName">道具名称</label>
           <div class="controls">
           <input type="text" name="itemName" placeholder="道具名称">
           </div>
           </div>
           <div class="control-group info">
           <label class="control-label" for="itemPrice">道具价格</label>
           <div class="controls">
           <input type="text" id="itemPrice" name="itemPrice" placeholder="道具价格" >
           </div>
           </div>
            <div class="control-group info">
           <label class="control-label" for="comment">道具说明</label>
           <div class="controls">
           <input type="text" id="comment" name="comment" placeholder="道具说明" >
           </div>
           </div>
            <div class="controls">

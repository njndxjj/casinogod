  ...
  <body>
   ...
   %>   
    ...
    <tr>  
         ...
         <td>${product.unit}</td>
         <td>
         <a href="deleteProduct.action?id=${product.id}"> 删除</a>
         <a href="configPage/updateProduct.jsp?id=${product.id}&productId=${product.productId}&productName=${product.productName}&diamond=${product.diamond}&unit=${product.unit}">更新</a>
         </td>
     </tr>  
     </s:iterator> 
      </table>  

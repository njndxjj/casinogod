   ...
   %>   
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
           <form class="form-horizontal"  action="addBossConfig.action" method="post">  
           <div class="control-group">
           <label class="control-label" for="maxHP">体力值</label>
           <div class="controls">
           <input type="text" id="maxHP" placeholder="3000" name="maxHP">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="bossType">类型</label>
           <div class="controls">
           <input type="text" id="bossType" placeholder="3000" name="bossType">
           </div>
           </div>
            <div class="control-group">
           <label class="control-label" for="userSize">最大数</label>
           <div class="controls">
           <input type="text" id="userSize" placeholder="30" name="userSize">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="time">周期</label>
           <div class="controls">
           <input type="text" id="time" placeholder="30" name="time">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="bossName">名称</label>
           <div class="controls">
           <input type="text" id="bossName" placeholder="30" name="bossName">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="bossImage">头像</label>
           <div class="controls">
           <input type="text" id="bossImage" placeholder="30" name="bossImage">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="otherNotes">说明</label>
           <div class="controls">
           <input type="text" id="otherNotes" placeholder="30" name="otherNotes">
           </div>
           </div>

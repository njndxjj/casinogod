  ...
  <body>
   ...
   %>   
    ...
    <div class="container-fluid">
        <div class="span9">
          <div class="hero-unit">
           <form class="form-horizontal"  action="updatePassword.action" method="post">  
           ...
           <div class="control-group">
           <label class="control-label" for="password">重置密码</label>
           <div class="controls">
           <input type="text" name="password" placeholder="112214">
           </div>
           </div>
            <div class="controls">

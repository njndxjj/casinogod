  ...
  <body>
   ...
   %>   
    ...
    <div class="container-fluid">
        <div class="span9">
          <div class="hero-unit">
           <form class="form-horizontal"  action="updateChatLimit.action" method="post">  
           <div class="control-group">
           <label class="control-label" for="account">编号</label>
           <div class="controls">
           <input type="text" id="account" placeholder="1" name="account" value=<%=request.getAttribute("account") %> readonly="readonly">
           </div>
           </div>

  ...
  <body>
   ...
   %>   
    ...
    <div class="container-fluid">
        <div class="span9">
          <div class="hero-unit">
           <form class="form-horizontal"  action="updateRank.action" method="post">  
           <div class="control-group">
           <label class="control-label" for="typeId">编号</label>
           <div class="controls">
           <input type="text" id="typeId" placeholder="1" name="typeId" value=<%=request.getAttribute("typeId") %> readonly="readonly">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="rankName">名称</label>
           <div class="controls">
           <input type="text" name="rankName" placeholder="xxx" value=<%=request.getAttribute("rankName") %> readonly="readonly">
           </div>
           </div>
           <div class="control-group">
        ...
        onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'2008-03-08 11:30:00',maxDate:'9999-12-31 24:59:59'});" value=<%=request.getAttribute("endTime") %>>
           ...
           <label class="control-label" for="rankDescription">描述</label>
           <div class="controls">
           <input type="text" name="rankDescription" placeholder="" value=<%=request.getAttribute("rankDescription") %>>
           </div>
           </div>

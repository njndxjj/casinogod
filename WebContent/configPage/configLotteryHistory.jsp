   ...
   %>   
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
              <form class="form-horizontal"  action="addlotteryHistory.action" method="post">  
           <div class="control-group">
           <label class="control-label" for="lotteryType">乐透类型</label>
           <div class="controls">
           <input type="text" name="lotteryType" placeholder="1">
           </div>
           </div>
            <div class="control-group info">
           <label class="control-label" for="openDateTime">开奖时间</label>
           <div class="controls">
           <input type="text" id="openDateTime" name="openDateTime" class="wdate"  class="Wdate" id="d412" 
           ...
           <div class="controls">
           <input type="text" name="result" placeholder="02 17 84 5">
           </div>
           </div>

  ...
  <body>
   ...
   %>   
    ...
    <div class="container-fluid">
        <div class="span9">
          <div class="hero-unit">
           <form class="form-horizontal"  action="updateReward.action" method="post">  
           ...
           <div class="control-group">
           <label class="control-label" for="day">登陆天数</label>
           <div class="controls">
           <input type="text" name="day" placeholder="112214" value=<%=request.getParameter("day") %>>
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="reward">奖励</label>
           <div class="controls">
           <input type="text" name="reward" placeholder="4" value=<%=request.getParameter("reward") %>>
           </div>
           </div>
            <div class="controls">

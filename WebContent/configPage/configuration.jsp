  ...
  <body>
   ...
   %>   
    ...
    <tr>  
        ...
        <th width="39%">个数</th>
        <th width="39%">奖励金额</th>
        <th width="39%">奖励道具编号</th>
        <th width="39%">操作</th>
    </tr> 
    <s:iterator id="ConfigurationInfo" value="#request.ConfigurationInfos"> 
    <tr>  
         <td>${ConfigurationInfo.id}</td>
         <td>${ConfigurationInfo.winTimes}</td>  
         <td>${ConfigurationInfo.rankSize}  </td>
         <td>${ConfigurationInfo.bossRewardNum}  </td>
         <td>${ConfigurationInfo.invitedReward}  </td>
         <td>${ConfigurationInfo.invitedItem}  </td>
         <td><a href="showConfigById.action?id=${ConfigurationInfo.id}">更新</a></td>
     </tr>  
     </s:iterator> 
      </table>  
      </div>

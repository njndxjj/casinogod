   ...
   %>   
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
              <form class="form-horizontal"  action="rewardConfig.action" method="post">  
           <div class="control-group">
           <label class="control-label" for="day">登陆天数</label>
           <div class="controls">
           <input type="text" id="day" placeholder="天数" name="day">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="reward">奖励</label>
           <div class="controls">
           <input type="text" name="reward" placeholder="1">
           </div>
           </div>
            <div class="controls">

   ...
   %>   
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
              <form class="form-horizontal"  action="registerDevice.action" method="post">  
           <div class="control-group">
           <label class="control-label" for="userId">用户名</label>
           <div class="controls">
           <input type="text" id="userId" placeholder="100000" name="userId">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="deviceToken">设备标识</label>
           <div class="controls">
           <input type="text" name="deviceToken" placeholder="2ed202ac08ea9033665e853a3dc8bc4c5e78f7a6cf8d55910df230567037dcc4">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="notes">说明</label>
           <div class="controls">
           <input type="text" name="notes" placeholder="说明">
           </div>
           </div>
            <div class="controls">

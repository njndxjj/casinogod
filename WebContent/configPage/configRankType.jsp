   ...
   %>   
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
              <form class="form-horizontal"  action="addRank.action" method="post">  
           <div class="control-group">
           <label class="control-label" for="rankName">名称</label>
           <div class="controls">
           <input type="text" id="rankName" placeholder="0" name="rankName">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="rankDescription">描述</label>
           <div class="controls">
           <input type="text" name="rankDescription" placeholder="XXXX">
           </div>
           </div>

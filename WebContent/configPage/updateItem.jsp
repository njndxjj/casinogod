  ...
  <body>
   ...
   %>   
    ...
    <div class="container-fluid">
        <div class="span9">
          <div class="hero-unit">
           <form class="form-horizontal"  action="updateItem.action" method="post">  
           ...
           <div class="controls">
           <input type="text" name="gameType" placeholder="0" value=<%=request.getParameter("gameType") %>>
           </div>
           </div>
           <div class="control-group">
           ...
           %>
           <div class="controls">
           <input type="text" name="itemName" placeholder="MagicItem_Switch" value=<%=itemName %>>
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="itemPrice">道具价格</label>
           <div class="controls">
           <input type="text" name="itemPrice" placeholder="10" value=<%=request.getParameter("itemPrice") %>>
           </div>
           </div>
           <div class="control-group">
            <%
           ...
           %>
           <label class="control-label" for="comment">道具说明</label>
           <div class="controls">
           <input type="text" name="comment" placeholder="test" value=<%=comment %>>
           </div>
           </div>
            <div class="controls">

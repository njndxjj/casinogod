   ...
   %>   
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
              <form class="form-horizontal"  action="lotteryConfig.action" method="post">  
           <div class="control-group">
           <label class="control-label" for="userId">账号</label>
           <div class="controls">
           <input type="text" id="userId" placeholder="账号" name="userId">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="lotteryId">期号</label>
           <div class="controls">
           <input type="text" id="lotteryId" placeholder="1234" name="lotteryId">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="lotteryValue">乐透值</label>
           <div class="controls">
           <input type="text" name="lotteryValue" placeholder="0">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="betAmount">筹码</label>
           <div class="controls">
           <input type="text" name="betAmount" placeholder="100">
           </div>
           </div>
           <div class="control-group">
           <label class="control-label" for="result">结果</label>
           <div class="controls">
           <input type="text" name="result" placeholder="false">
           </div>
           </div>
           <div class="control-group info">
           <label class="control-label" for="startDate">开奖时间</label>
           <div class="controls">
           <input type="text" id="betDateTime" name="betDateTime" class="wdate"  class="Wdate" id="d412" 

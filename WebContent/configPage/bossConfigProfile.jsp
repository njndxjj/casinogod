 ...
 <head>
  ...
  <body>
   ...
   %>   
    ...
    <s:iterator id="bossConfigInfo" value="#request.bossConfig"> 
    <tr>     
         <td>${bossConfigInfo.bossId}</td> 
         <td>${bossConfigInfo.bossType}</td> 
         <td>${bossConfigInfo.maxHP}</td>  
         <td>${bossConfigInfo.time}</td> 
         <td>${bossConfigInfo.userSize}</td> 
         <td>${bossConfigInfo.bossName}</td> 
         <td>${bossConfigInfo.bossImage}</td> 
         <td>${bossConfigInfo.otherNotes}</td> 
         <td>
         <a href="configUpdateBoss.action?bossId=${bossConfigInfo.bossId}&maxHP=${bossConfigInfo.maxHP}&bossType=${bossConfigInfo.bossType}
         &time=${bossConfigInfo.time}&otherNotes=${bossConfigInfo.otherNotes}&userSize=${bossConfigInfo.userSize}&bossName=${bossConfigInfo.bossName}&bossImage=${bossConfigInfo.bossImage}">更新</a>
         <a href="deletebossConfig.action?bossId=${bossConfigInfo.bossId}">删除</a>
         </td>
     </tr>  
     </s:iterator> 
      </table>  

...
//	alert(document.getElementById("firstPage").href+"&pageSize="+field.value);
  ...
  <body>
   ...
   %>   
    ...
    <s:iterator id="rewardInfo" value="#request.rewardInfos"> 
    <tr>  
         <td>${rewardInfo.id}</td>
         <td>${rewardInfo.day}</td>  
         <td>${rewardInfo.reward}</td>
         <td>
         <a href="deleteReward.action?id=${rewardInfo.id}"> 删除</a>
         <a href="configPage/updateReward.jsp?id=${rewardInfo.id}&day=${rewardInfo.day}&reward=${rewardInfo.reward}">更新</a>
         </td>
    </tr>  
    </s:iterator> 
    </table>  

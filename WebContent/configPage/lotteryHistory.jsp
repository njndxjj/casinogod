 ...
 <head>
  ...
  <body>
   ...
   %>   
    ...
    <s:iterator id="lotteryInfo" value="#request.lotteryInfos"> 
    <tr>  
         <td>${lotteryInfo.lotteryId}</td>
         <td>${lotteryInfo.lotteryType}</td>  
         <td>${lotteryInfo.openDateTime}</td>
         <td>${lotteryInfo.result}</td>
         <td>
         <a href="deleteLottery.action?lotteryId=${lotteryInfo.lotteryId}"> 删除</a>
         <a href="configPage/updateLottery.jsp?lotteryId=${lotteryInfo.lotteryId}&lotteryType=${lotteryInfo.lotteryType}&openDateTime=${lotteryInfo.openDateTime}&result=${lotteryInfo.result}">更新</a>
         </td>
    </tr>  
 </s:iterator> 
</table>  
